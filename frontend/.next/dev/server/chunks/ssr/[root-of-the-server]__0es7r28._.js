...
"[project]/frontend/src/features/auth/ui/LoginForm.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const LoginForm = ()=>{
    ...
    const setAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$features$2f$auth$2f$model$2f$auth$2e$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"])((state)=>state.setAuth);
    const handleSubmit = async (e)=>{
        e.preventDefault();
        setError('');
        setIsLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$shared$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/auth/login', {
                email,
                password
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0es7r28._.js.map